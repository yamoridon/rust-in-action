...
const NTP_MESSAGE_LENGTH: usize = 48; // 12 x 4 バイト
const NTP_TO_UNIX_SECONDS: i64 = 2_208_988_800;
const LOCAL_ADDR: &'static str = "0.0.0.0:12300";  // 12300 は規定ポート番号
...
impl Clock {
    ...
    fn set<Tz: TimeZone>(t: DateTime<Tz>) -> () {
        ...
        let systime_ptr = &systime as *const SYSTIME;
...
fn main() {
    let app = App::new("clock")
        ...
        .after_help(
            "Note: UNIX simestamps are parsed as whole \
